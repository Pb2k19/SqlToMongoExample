...
//    KodPocztowy = "06-500",
//    Miejscowosc = "Mława",
//    NumerDomuMieszkania = "26B",
//    NumerTelefonu = "000-000-000",
//    Ulica = "Warszawska",
//    Login = "AJanusz",
//    NazwaFirmy = "Blekojad",
//    Nip = "4656556546646"
...
var pojazdy = new Pojazd
{
    ...
    MocSilnikaKm = 140,
    Model = "Omega",
    NumerVin = "6444AD98945AF0AFAEF",
    Opis = "Zardzewiały złom",
    PojemnoscSilnikaCm3 = 2199,
    Typ = "Sedan",
    Naprawy = new() { naprawaId }
};

var pracownik = new Pracownik()
{
    Id = pracownikId,
    Haslo = "a2sdaw45154awdasdf4745163d2e37142e5b25feb8021af8acbbab22c251b1ab",
    Imie = "Krzysztof",
    Nazwisko = "Warmiński",
    KodPocztowy = "05-600",
    Miejscowosc = "Wadowice",
    NumerDomuMieszkania = "21",
    NumerTelefonu = "030-420-070",
    Ulica = "Szkolna",
    Login = "KW",
    DataZatrudnienia = new DateTime(2022, 5, 11),
    Naprawy = new() { naprawaId },
    NazwaStanowiska = "Mechanik",
    PoziomDostepu = 3,
};
...
{
    Id = naprawaId,
    Opis = "Legancka fuszerka",
    DataRozpoczecia = new DateTime(2023, 5, 10, 10, 29, 31),
    DataZakonczenia = new DateTime(2023, 5, 11, 12, 52, 15),
    Faktura = new()
    {
        MetodaPlatnosci = "Karta",
        DataWystawienia = new DateTime(2023, 5, 13, 8, 29, 10),
        ElementyFaktury = new()
        {
            new ElementFaktury
            {
                Cena = 500,
                Liczba = 1,
                Nazwa = "Nadkole prawy tył omega",
                Opis = "Wspaniałe nadkole do omegi",
                StawkaVat = 23
            },
            new ElementFaktury
            {
                Cena = 500,
                Liczba = 1,
                Nazwa = "Tarcza sprzęgła omega",
                Opis = "Wspaniała tarcza sprzęgła do omegi",
                StawkaVat = 23
            },
        },
    },
    ...
    IdPojazdu = pojazdId,
    Status = "Ukończono",
    Pracownicy = new() { pracownikId }
};

var zamowienie = new Zamowienie 
{ 
    DataZlozenia = new DateTime(2020, 10, 10), 
    DataZrealizowania = new DateTime(2020, 10, 12), 
    ElementyZamowienia = new() { idElementu1, idElementu2 } 
};
...
var magazyn = new List<ElementMagazynu>
{
    new ElementMagazynu
    {
        ...
        StawkaVat = 23,
        Id = idElementu1,
        Opis = "Tarcza sprzęgła do omegi",
        Nazwa = "Tarcza sprzegła",
        MasaG = 1000
    },
    new ElementMagazynu
    {
